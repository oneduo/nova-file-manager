...
<template>
  <div
    ...
    class="absolute inset-0 z-50 pt-16 bg-gray-100/90 dark:bg-gray-700/80 rounded-md  w-full h-full flex justify-start flex-col items-center border border-blue-500"
  >
