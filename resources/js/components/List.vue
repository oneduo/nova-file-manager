  ...
  <table class="min-w-full divide-y divide-gray-300 dark:divide-gray-600/50">
    <tbody class="divide-y divide-gray-200 dark:divide-gray-900/20">
      <tr v-if="folders?.length" class="border-t border-gray-200 dark:border-gray-700/50">
        <th class="py-2 text-start text-xs font-semibold text-gray-500" colspan="2" scope="colgroup">
          {{ __('Folders') }}
        </th>
      </tr>
      <template v-for="folder in folders" :key="folder.id">
        <tr class="cursor-pointer">
          ...
          <td
            class="relative whitespace-nowrap py-4 text-end text-xs font-medium"
            ...
            <div class="inline-flex items-center">
              <div class="relative flex-1 flex items-center justify-end">
                <Menu as="div" class="relative inline-block text-start">
                  <MenuButton
                    class="flex items-center text-gray-500 hover:text-blue-500 hover:bg-gray-50 dark:hover:bg-gray-600/50 rounded-full focus:outline-none me-2 p-0.5"
                  >
                    <EllipsisHorizontalIcon class="h-3 w-3" />
                  </MenuButton>

                  <MenuItems
                    class="z-50 ltr:origin-top-right rtl:origin-top-left absolute end-0 mt-2 w-36 select-none overflow-hidden bg-white dark:bg-gray-900 rounded-md border border-gray-200 dark:border-gray-700 px-1"
                  >
                    <div class="py-1">
