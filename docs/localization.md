...
The package uses the following translation keys, you can create your own and translate them to your own language.

For the time being, the package comes with English translations builtin.
...
```json
{
  ...
  "NovaFileManager.edit.originalName": "Original name : :name",
  "NovaFileManager.pintura.loadingError": "Unable to load Pintura editor"
}
```
